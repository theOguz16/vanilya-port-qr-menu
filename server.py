...
DEFAULT_CATEGORY_ORDER = ["coldDrinks", "hotDrinks", "foods", "desserts"]
...
def apply_requested_menu_products_migration(conn):
    migration_id = "20260703-full-menu-images-order"
    ...
    category_rows = [
        ("coldDrinks", DEFAULT_CATEGORY_LABELS["coldDrinks"], 0, now, now),
        ("hotDrinks", DEFAULT_CATEGORY_LABELS["hotDrinks"], 10, now, now),
        (food_category_id, DEFAULT_CATEGORY_LABELS["foods"], 20, now, now),
